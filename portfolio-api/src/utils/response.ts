...
export const createNoContentResponse = (): APIResponse => {
  return {
    statusCode: 204,
    headers: {
      'Content-Type': 'application/json',
...
export const createErrorResponse = (message: string, statusCode: number = 400, code?: string, details?: any): APIResponse => {
  const errorBody: any = {
    error: {
      message,
      ...(code && { code }),
